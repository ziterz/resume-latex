...
\begin{document}
	...
	% Summary
	% \header{Summary}
	% 	Experienced Frontend Engineer specializing in Web and Mobile Development, with a track record of developing 10+ applications. Has 4 years of experience as a Full-Stack JavaScript Instructor, mentoring 800+ participants in both fundamental and advanced topics, significantly enhancing their comprehension and achieving a 93\% satisfaction rate. Skilled in using modern technologies to deliver high-quality, user-centric solutions.
	...
	\skills{
		...
		\item \textbf{Technologies:} Git, Node.js, RESTful APIs, Firebase, PostgreSQL, MongoDB, GraphQL
	...
	\header{Educational Background}
		\shortitem{\MakeUppercase{Apple Developer Academy}}{Feb 2023 - Dec 2023}{iOS Developer}{Batam, Indonesia}
		\shortitem{\MakeUppercase{Indonesia University of Education}}{Aug 2015 - Oct 2019}{Bachelor of Education in Computer Science}{Bandung, Indonesia}
