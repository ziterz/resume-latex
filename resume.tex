...
\begin{document}
	...
	\header{Professional Experience}
		...
		\liststart
			\item Design, build, and enhance scalable web applications, including front-end and back-end functionalities. \vspace{-1mm}
			\item Design and manage databases, and create RESTful APIs for data handling and inter-service communication. \vspace{-1mm}
			\item Monitor and optimize application performance, troubleshoot issues, and document code and processes.
		\listend
