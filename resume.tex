...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\skills{
			...
			\item \textbf{Android:} Java, Kotlin, RxJava, Dagger, Gradle, Jetpack
			\item \textbf{Hybrid:} JavaScript, Vue, React, React Native, Redux
			\item \textbf{Others Technologies:} OOP, MVC, MVVM, Firebase, Git, RESTful APIs, Agile, Scrum, Jira, Unit and UI Tests
		}		
