...
\begin{document}
	...
	\header{Professional Experience}
		...
		\liststart
			...
			\item Taught courses in Web Fundamentals, JavaScript, Node.js, React, Redux, React Native.
		\listend
		...
		\liststart
			...
			\item Taught courses in JavaScript, Node.js, React, Redux, TDD, Jest, MongoDB, GraphQL.
		\listend
