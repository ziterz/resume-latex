...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\header{Projects}
			...
			\liststart
				\item Developing a hybrid board game with a native iOS companion app that integrates physical and digital elements using NFC technology for interactions.
			...
			\liststart
				\item Built a native app for iPadOS to assist you in creating your very own personalized mechanical keyboard.
			...
			\liststart
				\item Built a native iOS app that brings your local newspaper to life using the power of ARKit.
				\item Using Xcode, UIKit, SceneKit, ARKit, and AVKit.
			\listend

			\longitem{HCIS Imeco}{Sep 2022 - Jan 2023}{Front End Developer}{}
			\liststart
				\item Built an HCIS (Human Capital Information System) application for a company such as detailed employee data, salaries, attendance, and company requirements.
			...
			\liststart
				\item Built an online application called “Speed Online” for ordering tickets for ship crossings in North Kalimantan.
			...
			\liststart
				\item Built an application called “JastipinAja” for users who miss their regional food during the pandemic era, providing same-day delivery.
			...
			\liststart
				\item Built an application called “Dicicilaja” that includes marketplace, sales app, branch office, rewards, simulation, and order in features.
